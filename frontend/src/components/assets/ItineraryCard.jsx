    ...
    <div>
      {/* <Card className="overflow-hidden w-full">
        ...
        <CardContent className="p-6 text-sm pt-2 pb-2">
          <div className="grid gap-1">
            ...
            <ul className="grid gap-1">
                ...
                <span>
                  {itinerary?.destinationDetails?.modeOfTravel &&
                    itinerary?.destinationDetails?.modeOfTravel
                      .charAt(0)
                      .toUpperCase() +
                      itinerary?.destinationDetails?.modeOfTravel.slice(1)}
                </span>
              </li>
              <li className="flex items-center justify-between">
              ...
              <li className="flex items-center justify-between">
                ...
                <span>{itinerary.destinationDetails?.travelDistance}</span>
              </li>
              ...
              <div className="grid gap-1 text-left">
                <div className="font-semibold">
                  {itinerary.placeOneDetails?.name?.length > 20
                    ? itinerary.placeOneDetails?.name?.substring(0, 20) + "..."
              ...
              <div className="grid auto-rows-max gap-1 text-right">
                <div className="font-semibold">
                  {itinerary.placeTwoDetails?.name?.length > 20
                    ? itinerary.placeTwoDetails?.name?.substring(0, 20) + "..."
          ...
          <Separator className="my-4" />
          <div className="grid gap-1">
            <div className="font-semibold hidden">Share Itinerary</div>
